...
export const metadata: Metadata = {
  title: "Sapphire Townhouse Bumiayu - Hunian Modern di Bumiayu",
  description: "Temukan properti impian Anda di Sapphire Townhouse Bumiayu, hunian modern dengan lokasi strategis di Bumiayu dengan fasilitas lengkap, tempat ibadah terintegrasi, taman dan gazebo. Developer Kredibel, Legalitas Terjamin, Proses Mudah. Harga terjangkau.",
  icons: {
