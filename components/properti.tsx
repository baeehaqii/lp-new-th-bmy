...
export default function Properties() {
  ...
  const properties = [
    {
      ...
      area: "35",
      description:
        "Tipe 35/84 dengan luas bangunan 35 m² adalah pilihan sempurna untuk keluarga muda yang ingin memiliki rumah pertama. Desain modern dengan layout yang efisien untuk memaksimalkan setiap ruang dengan harga terjangkau.",
      certificate: "SHM",
    },
    {
      id: 2,
      ...
      area: "40",
      description:
        "Tipe 40/84 dengan luas bangunan 40 m² menawarkan varian dengan layout yang lebih fungsional. Cocok untuk keluarga muda yang mencari hunian minimalis dengan desain modern dan harga terjangkau.",
      certificate: "SHM",
    },
    {
      id: 3,
      ...
      area: "52",
      description:
        "Tipe 52/84 dengan luas bangunan 52 m² menawarkan ruang yang nyaman untuk keluarga muda. Dilengkapi dengan 2 kamar tidur dan desain modern yang optimal untuk kebutuhan keluarga dengan investasi terjangkau.",
      certificate: "SHM",
    },
    {
      id: 4,
      ...
      area: "53",
      description:
        "Tipe 53/84 dengan luas bangunan 53 m² menyediakan ruang yang lebih lega untuk keluarga yang menginginkan kenyamanan maksimal dengan 2 kamar tidur, 2 kamar mandi, dan desain modern yang elegan.",
      certificate: "SHM",
    },
    {
      id: 5,
      ...
      area: "55",
      description:
        "Tipe 55/114 dengan luas bangunan 55 m² dan luas tanah 114 m² adalah pilihan ideal untuk keluarga yang membutuhkan lebih banyak ruang. Dengan 3 kamar tidur dan 2 kamar mandi, desainnya menawarkan fleksibilitas dan kenyamanan optimal.",
      certificate: "SHM",
    },
    {
      id: 6,
      ...
      area: "68",
      description:
        "Tipe 68/126 dengan luas bangunan 68 m² dan luas tanah 126 m² menawarkan hunian yang spacious dan modern. Sempurna untuk keluarga yang menginginkan ruang hidup yang luas dengan fasilitas lengkap dan desain berkualitas.",
      certificate: "SHM",
    },
    {
      id: 7,
      ...
      area: "75",
      description:
        "Tipe 75/126 dengan luas bangunan 75 m² dan luas tanah 126 m² adalah pilihan terbaik untuk keluarga yang menginginkan kenyamanan maksimal. Dengan desain premium dan layout yang optimal, rumah ini menawarkan investasi jangka panjang yang bernilai.",
      certificate: "SHM",
    },
  ]
  ...
  const siteplan = {
    ...
    name: "Siteplan Sapphire Townhouse Bumiayu",
    description:
      "Masterplan perumahan Sapphire Townhouse Bumiayu yang menampilkan layout, jalan, ruang terbuka hijau, tempat ibadah terintegrasi, taman dan gazebo dengan sistem keamanan terpadu untuk kenyamanan optimal.",
  }
  ...
  const location = {
    embed: '<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3957.846333426053!2d109.008874975903!3d-7.258323571310445!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6f8f6e53d95397%3A0xf19552f4f533b771!2sSapphire%20Townhouse%20Bumiayu!5e0!3m2!1sen!2sid!4v1762013234050!5m2!1sen!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>',
    name: "Denah Lokasi Sapphire Townhouse Bumiayu",
    ...
    <section id="tipe-rumah" className="section">
      <div className="container">
        ...
        <p className="section-subtitle">
          Temukan rumah impian Anda di Sapphire Townhouse Bumiayu dengan berbagai tipe yang dirancang khusus untuk keluarga muda yang ingin memiliki rumah pertama dengan harga terjangkau.
        </p>
