            ...
            <div className="container">
                <div className="youtube-grid">
                    ...
                    <div className="youtube-content">
                        <h2 className="youtube-title">Subscribe Channel Sapphire Townhouse Bumiayu</h2>
                        <p className="youtube-description">
                            Ikuti channel YouTube kami untuk mendapatkan update terbaru tentang Sapphire Townhouse Bumiayu,
                    ...
                    <div className="youtube-video-wrapper">
                        {!isVideoLoaded ? (
                            ...
                            <iframe
                                ...
                                title="Sapphire Townhouse Bumiayu"
                                frameBorder="0"
